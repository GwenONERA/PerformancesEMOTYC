...
```
```output
Loading weights:   0%|          | 0/201 [00:00<?, ?it/s]Référence : 101 phrases × 19 labels = 1919 cellules
...
```
```output
config.json:   0%|          | 0.00/508 [00:00<?, ?B/s]tokenizer_config.json:   0%|          | 0.00/25.0 [00:00<?, ?B/s]sentencepiece.bpe.model:   0%|          | 0.00/811k [00:00<?, ?B/s]tokenizer.json: 0.00B [00:00, ?B/s]config.json: 0.00B [00:00, ?B/s]model.safetensors:   0%|          | 0.00/443M [00:00<?, ?B/s]Loading weights:   0%|          | 0/201 [00:00<?, ?it/s]Données : 101 phrases × 19 labels = 1919 cellules
...
══════════════════════════════════════════════════════════════
  ...
  emo                    ↔ degout                 : 84 → 83
  admiration             ↔ autre                  : 83 → 80
  fierte                 ↔ joie                   : 80 → 79
  Erreurs après swaps : 79

══════════════════════════════════════════════════════════════
 PHASE 3 · Classifieurs par label
══════════════════════════════════════════════════════════════
  emo                        DTree (prof=4, feuilles=9)  ✓
  emo_comportementale        LogReg (19 logits)        ✓
  emo_designee               LogReg (19 logits)        ✓
  emo_montree                DTree (prof=8, feuilles=12)  ✓
  emo_suggeree               DTree (prof=6, feuilles=12)  ✓
  emo_base                   DTree (prof=5, feuilles=14)  ✓
  emo_complexe               LogReg (19 logits)        ✓
  admiration                 LogReg (19 logits)        ✓
  autre                      seuil = 0.999958         ✓
  colere                     DTree (prof=7, feuilles=18)  ✓
  culpabilite                seuil = 0.031289         ✓
  degout                     seuil = 0.011405         ✓
  embarras                   LogReg (19 logits)        ✓
  fierte                     seuil = 0.986828         ✓
...
══════════════════════════════════════════════════════════════
  ...
  [emo]  Arbre (prof=4) :
    ...
    |   |--- logit_autre <= 0.19
    |   |   |--- logit_emo <= -7.94
    |   |   |   |--- logit_tristesse <= -11.15
    … (25 lignes)

  [emo_comportementale]  +2.561·logit_emo_comportementale + +1.170·logit_embarras + +1.140·logit_emo_complexe + +1.022·logit_colere +0.053 > 0

  [emo_designee]  -2.053·logit_admiration + +1.655·logit_emo_designee + -1.516·logit_emo_montree + +1.449·logit_emo_complexe +0.054 > 0

  [emo_montree]  Arbre (prof=8) :
    |--- logit_emo_montree <= 1.25
    |   |--- logit_autre <= 9.02
    |   |   |--- logit_emo_designee <= -11.75
    |   |   |   |--- class: 1
    |   |   |--- logit_emo_designee >  -11.75
    |   |   |   |--- logit_colere <= -10.90
    |   |   |   |   |--- class: 0
    |   |   |   |--- logit_colere >  -10.90
    |   |   |   |   |--- logit_emo_designee <= -11.14
    |   |   |   |   |   |--- logit_tristesse <= -11.15
    |   |   |   |   |   |   |--- class: 0
    |   |   |   |   |   |--- logit_tristesse >  -11.15
    … (25 lignes)

  [emo_suggeree]  Arbre (prof=6) :
    |--- logit_emo_suggeree <= -3.11
    |   |--- logit_tristesse <= -4.13
    |   |   |--- logit_surprise <= -11.03
    |   |   |   |--- class: 1
    |   |   |--- logit_surprise >  -11.03
    |   |   |   |--- logit_surprise <= -4.35
    |   |   |   |   |--- logit_emo_base <= -9.42
    |   |   |   |   |   |--- logit_emo_suggeree <= -9.28
    |   |   |   |   |   |   |--- class: 0
    |   |   |   |   |   |--- logit_emo_suggeree >  -9.28
    |   |   |   |   |   |   |--- class: 1
    |   |   |   |   |--- logit_emo_base >  -9.42
  ...
  [emo_complexe]  -458.600·logit_culpabilite + -416.995·logit_autre + -371.843·logit_surprise + +314.361·logit_emo_montree -394.115 > 0

  [admiration]  -2514.327·logit_joie + +1568.878·logit_embarras + +1530.134·logit_peur + +1441.188·logit_admiration -816.295 > 0

  [autre]  σ(logit[8]) ≥ 0.999958

  [colere]  Arbre (prof=7) :
    |--- logit_emo_montree <= -1.93
    |   |--- logit_surprise <= -10.91
    |   |   |--- class: 1
    |   |--- logit_surprise >  -10.91
    |   |   |--- logit_autre <= 7.99
    |   |   |   |--- logit_emo_suggeree <= -2.97
    |   |   |   |   |--- logit_autre <= -8.69
    |   |   |   |   |   |--- logit_tristesse <= -11.16
  ...
  [culpabilite]  σ(logit[10]) ≥ 0.031289

  [degout]  σ(logit[11]) ≥ 0.011405

  [embarras]  +54.650·logit_peur + +48.280·logit_colere + +39.095·logit_emo_designee + +29.328·logit_embarras -6.749 > 0

  [fierte]  σ(logit[13]) ≥ 0.986828

  [jalousie]  σ(logit[14]) ≥ 0.002781

  [joie]  +158.778·logit_fierte + +124.094·logit_joie + -109.080·logit_colere + +87.584·logit_emo_suggeree -23.274 > 0

  [peur]  σ(logit[16]) ≥ 0.172037

  [surprise]  σ(logit[17]) ≥ 0.506692

  [tristesse]  +501.708·logit_colere + +374.785·logit_emo_designee + -344.391·logit_fierte + -334.376·logit_admiration -23.782 > 0

══════════════════════════════════════════════════════════════
 ⚠  Les classifieurs multi-logits (LR/DTree) sont ajustés
    sur ces 101 exemples. Pour de nouvelles phrases, collecter
